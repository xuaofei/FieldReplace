...
CChinese2PinYin::CChinese2PinYin()
{
}
...
void CChinese2PinYin::GetPinYin(string& Chinese, string& PinYin)
{
	int chinese_str_len = Chinese.size();
...
void CChinese2PinYin::GetOtherCodePinYin(int nCode, string& strValue)
{
	switch (nCode)
	{
